...
public class WorkspaceJoinApproveAction extends WorkspaceJoinStateMachineSupport
	...
	public void execute(StateContext<WorkspaceJoinRequestStatus, WorkspaceJoinRequestEvent> context) {
		...
		WorkspaceJoinRequestHistory history = joinRequest.approve(actor(context), now());
