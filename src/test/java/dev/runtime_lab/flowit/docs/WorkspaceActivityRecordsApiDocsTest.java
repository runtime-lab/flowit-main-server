	...
	void activityRecords() throws Exception {
		...
		mockMvc.perform(get("/v1/workspaces/{workspaceId}/activity-records", 2001L)
			...
			.andDo(document("workspaces-activity-records",
				...
				queryParameters(
					stringParameter("topic").description("활동 조회 주제입니다. 생략하면 `ALL`입니다. link:workspaces-activity-records-enum-reference.html#activity-record-topic[ActivityRecordTopic]을 참고합니다.").optional(),
				...
				responseFields(
					...
					fieldWithPath("data.items[].domain").type(JsonFieldType.STRING).description("활동 도메인입니다. link:workspaces-activity-records-enum-reference.html#activity-record-domain[ActivityRecordDomain]을 참고합니다."),
					...
					fieldWithPath("data.items[].target.type").type(JsonFieldType.STRING).description("활동 대상 타입입니다. link:workspaces-activity-records-enum-reference.html#activity-target-type[ActivityTargetType]을 참고합니다."),
					...
					fieldWithPath("data.items[].action").type(JsonFieldType.STRING).description("활동 액션입니다. 한 활동 레코드는 하나의 액션만 가집니다. link:workspaces-activity-records-enum-reference.html#activity-record-action[ActivityRecordAction]을 참고합니다."),
					...
					fieldWithPath("data.items[].changes[].element").type(JsonFieldType.STRING).description("변경 요소입니다. link:workspaces-activity-records-enum-reference.html#activity-change-element[ActivityChangeElement]를 참고합니다."),
